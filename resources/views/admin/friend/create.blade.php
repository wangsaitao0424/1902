	...
	<div id="pageAll">
		...
		<div class="page ">
			...
			<div class="banneradd bor">
				...
				<form  method="post" action="{{url('friend/save')}}" enctype="multipart/form-data" onsumit="return check()">
				@csrf
				<div class="baBody">
					<div class="bbD">
						网站名称：<input type="text" name="site_name" class="input3" onblur="site1()"  /><span class="span1" style="color:red">*</span>@php echo $errors->first('site_name'); @endphp
					</div>
					<div class="bbD">
						网站网址：<input type="text" name="friend_url" class="input3" onblur="url1()" /><span class="span2" style="color:red">*</span>@php echo $errors->first('friend_url'); @endphp
					</div>
					<div class="bbD">
					...
					<div class="bbD">
						网站联系人：<input type="text" name="friend_linkman" class="input3" />
					</div>
					<div class="bbD">
						网站LOGO：<input type="file" name="files"/>
					</div>
					
					<div class="bbD">
						网站介绍：
						<div class="btext">
							<textarea class="text2" name="friend_desc"></textarea>
						</div>
					</div>
					<!-- <div class="bbD">
					...
					<div class="bbD">
						是否显示：<label><input type="radio" checked="checked"
							name="is_state" value="0" />&nbsp;是</label><label><input type="radio"
							name="is_state" value="1" />&nbsp;否</label>
					</div>
					<div class="bbD">
						<p class="bbDP">
