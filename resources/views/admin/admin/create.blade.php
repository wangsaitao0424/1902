		...
		<div class="page ">
			...
			<div class="banneradd bor">
				...
				<div class="baBody">
					...
					<div class="bbD">
						用户等级：<input type="text" name="user_grade" class="input3" />
						@php echo $errors->first('user_grade')  @endphp
					</div>
					<div class="bbD">
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;性别：<input type="radio" name="user_sex" value="1" />男&nbsp;&nbsp;<input type="radio" name="user_sex" value="2" />女@php echo $errors->first('user_sex')  @endphp
					</div>
					<div class="bbD">
